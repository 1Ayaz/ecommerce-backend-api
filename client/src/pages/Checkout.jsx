...
export default function Checkout() {
    ...
    useEffect(() => {
        if (user) {
            ...
            API.get('/users/addresses').then(res => {
                ...
                .finally(() => setFetchedAddresses(true));
        } else {
            setFetchedAddresses(false);
        }
    }, [user]);
    ...
    useEffect(() => {
        if (fetchedAddresses && user && savedAddresses.length === 0 && !selectedAddr) {
            // Small delay for UX
    ...
    }, [fetchedAddresses, user, savedAddresses, selectedAddr]);
        ...
        const fetchPreview = async () => {
            ...
            try {
                ...
                const orderData = {
                    ...
                    deliveryAddress: selectedAddr || { fullAddress: 'Pending Location', location: loc || { lat: 0, lng: 0 } },
