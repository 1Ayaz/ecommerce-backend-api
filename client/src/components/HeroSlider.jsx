...
export default function HeroSlider() {
    ...
    // Fetch admin-managed banners from API
    useEffect(() => {
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    {slides[current].title && (
                        <div className="relative z-10 px-5 md:px-16 max-w-2xl text-white">
